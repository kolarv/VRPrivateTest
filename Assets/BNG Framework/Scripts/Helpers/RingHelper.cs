...
namespace BNG {
    ...
    public class RingHelper : MonoBehaviour {
        ...
        /// <summary>
        /// Identificator for presenter.
        /// </summary>
        [SerializeField]
        public bool IsPresenter = false; //proste mi ho tam neches zobrazovat
        ...
        void Update() {
            ...
            //to not hide presenter, wtf
            if (ringSizeInRange == 0 && ringSizeGrabbable == 0)
            {
                return;
            }
